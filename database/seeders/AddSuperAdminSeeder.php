...
//        ]);
        ...
        SystemSetting::upsert([
            ...
            ["name" => "system_name", "data" => "ta3limx Saas - School Management System", "type" => "string"],
            ...
            ["name" => "short_description", "data" => "ta3limx-Saas - Manage Your School", "type" => "text"],
        ...
        $systemSettings = [
            [
                'name' => 'hero_title_1',
                'data' => 'Opt for ta3limx Saas 14+ robust features for an enhanced educational experience.',
                'type' => 'text'
            ],
            [
                'name' => 'hero_title_2',
            ...
            [
                'name' => 'tag_line',
                'data' => 'Transform School Management With ta3limx SaaS',
                'type' => 'text'
            ],
            [
                'name' => 'mobile',
            ...
            [
                ...
                'data' => 'Experience the future of education with our ta3limx SaaS platform. Streamline attendance, assignments, exams, and more. Elevate your school\'s efficiency and engagement.',
                'type' => 'text'
            ],
            [
