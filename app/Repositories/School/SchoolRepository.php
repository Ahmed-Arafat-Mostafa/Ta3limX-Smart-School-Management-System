...
class SchoolRepository extends BaseRepository implements SchoolInterface {
    ...
    public function updatta3limxAdmin($array, $image = null) {
        $data = (object)$array;
        ...
        if ($user) {
            ...
            $this->updatta3limxdatabase($data, $school, $image_path);
    ...
    public function updatta3limxdatabase($user, $school, $image_path)
    {
