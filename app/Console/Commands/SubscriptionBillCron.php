...
class SubscriptionBillCron extends Command
{
    ...
    public function handle()
    {
        ...
        foreach ($subscriptionBill as $key => $bill) {
            ...
            // Remove cache
            $this->cache->removta3limxCache(config('constants.CACHE.SCHOOL.FEATURES'),$bill->school_id);
        }
        ...
        foreach ($subscriptions as $subscription) {
            ...
            // Remove cache
            $this->cache->removta3limxCache(config('constants.CACHE.SCHOOL.FEATURES'),$subscription->school_id);
        }
