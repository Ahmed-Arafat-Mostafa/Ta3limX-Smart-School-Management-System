    ...
    public function razorpay(Request $request)
    {
        ...
        try {
            ...
            if ($metadata && isset($data->event) && $data->event == 'payment.captured') {
                ...
                $this->cache->removta3limxCache(config('constants.CACHE.SCHOOL.FEATURES'),$metadata->school_id);
        ...
        try {
            ...
            if ($event == 'charge.completed') {
                ...
                try {
                    ...
                    // Clear cache
                    if ($schoolId) {
                        $this->cache->removta3limxCache(config('constants.CACHE.SCHOOL.FEATURES'), $schoolId);
                    }
