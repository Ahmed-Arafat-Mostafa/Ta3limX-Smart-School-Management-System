...
class SubscriptionController extends Controller
{
    ...
    public function cancel_upcoming($id = null)
    {
        ...
        try {
            ...
            $this->cache->removta3limxCache(config('constants.CACHE.SCHOOL.SETTINGS'));
    ...
    public function payment_success($check_out_session_id, $subscriptionBill_id = null, $package_id = null, $type = null, $subscription_id = null, $isCurrentPlan = null)
    {
        ...
        $this->cache->removta3limxCache(config('constants.CACHE.SCHOOL.FEATURES'), $subscriptionBill->school_id);
    ...
    public function update_expiry(Request $request)
    {
        ...
        try {
            ...
            $this->cache->removta3limxCache(config('constants.CACHE.SCHOOL.FEATURES'), $request->school_id);
            DB::commit();
    ...
    public function start_immediate_plan($id = null, $type = null)
    {
        ...
        try {
            ...
            $this->cache->removta3limxCache(config('constants.CACHE.SCHOOL.FEATURES'));
    ...
    public function update_current_plan(Request $request)
    {
        ...
        try {
            ...
            $this->cache->removta3limxCache(config('constants.CACHE.SCHOOL.FEATURES'), $new_subscription->school_id);
            DB::commit();
            ResponseService::successResponse('Data Updated Successfully');
        } catch (Throwable $e) {
            ResponseService::logErrorResponse($e);
    ...
    public function destroy($id)
    {
        ...
        try {
            ...
            $this->cache->removta3limxCache(config('constants.CACHE.SCHOOL.SETTINGS'), $subscription->school_id);
            DB::commit();
