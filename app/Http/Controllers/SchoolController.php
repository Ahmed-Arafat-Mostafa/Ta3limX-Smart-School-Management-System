...
class SchoolController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        try {
            ...
            $database_name = 'ta3limx_' . $schoolData->id . '_' . strtolower(strtok($school_name, " "));
    ...
    private function replacePlaceholders($request, $user, $settings, $school_code)
    {
        ...
        $placeholders = [
            ...
            '{system_name}' => $settings['system_name'] ?? 'ta3limx Saas',
            '{url}' => url('/'),
    ...
    public function update(Request $request, $id)
    {
        ...
        try {
            ...
            $this->cache->removta3limxCache(config('constants.CACHE.SCHOOL.SETTINGS'), $request->edit_id);
    ...
    public function updateAdmin(Request $request)
    {
        ...
        try {
            ...
            $this->schoolsRepository->updatta3limxAdmin($admin_data, $request->edit_admin_image); // Call updatta3limxAdmin function of Schools Repository
            ...
            if ($request->resend_email) {
                ...
                $data = [
                    'subject' => 'Welcome to ' . $settings['system_name'] ?? 'ta3limx Saas',
                    'email' => $request->edit_admin_email,
    ...
    public function sendCustomEmail($school_id, $data, $subject)
    {
        try {
            ...
            $placeholders = [
                ...
                '{system_name}' => $systemSettings['system_name'] ?? 'ta3limx-SaaS',
    ...
    private function replaceInquiryEmailPlaceholders($request, $settings)
    {
        ...
        $placeholders = [
            '{system_name}' => $settings['system_name'] ?? 'ta3limx Saas Support Team',
            '{school_name}' => $request->school_name,
